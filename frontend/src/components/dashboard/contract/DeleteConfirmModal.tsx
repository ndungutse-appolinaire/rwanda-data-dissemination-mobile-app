 ...
 * Modal for confirming the deletion of a contract
 */
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <div className="mb-6">
          <p className="text-gray-700">
            ...
            <span className="font-semibold">{getEmployeeName(contract.employeeId)}</span>? This will
            permanently remove the contract and all associated data.
          </p>
        </div>
        <div className="flex flex-col sm:flex-row items-center justify-end space-y-2 sm:space-y-0 sm:space-x-3">
          ...
          <button
            ...
            aria-label="Confirm contract deletion"
          >
            Delete Contract
          </button>
        </div>
